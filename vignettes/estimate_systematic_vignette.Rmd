---
title: "estimate_systematic() Tutorial"
...
estimate_systematic( Y.1 + Y.0 ~ Z, ~ A + B, data=df )$beta.hat
estimate_systematic( Yobs ~ Z, ~ A + B, data=df )$beta.hat
estimate_systematic( Yobs ~ Z, ~ A + B, data=df, method="OLS" )$beta.hat
```
