...
```{r, echo=TRUE, cache=TRUE}
tst3a2 <- fishpidetect.interact( Y=ToyData$Y, Z=ToyData$Z, W=W1, X=X34, B=B, verbose=FALSE )
print( tst3a2 )
```

For comparison, we next include all terms.
```{r, echo=TRUE, cache=TRUE}
tst3a2b <- fishpidetect.interact( Y=ToyData$Y, Z=ToyData$Z, W=W1, X=Xfull, B=B, verbose=FALSE )
print( tst3a2b )
```
...
tst3b <- fishpidetect.interact( Y=ToyData$Y, Z=ToyData$Z, W=W12, B=B, verbose=FALSE )
print( tst3b)
```
...
```{r, echo=TRUE}
tst3c <- fishpidetect.interact( Y=ToyData$Y, Z=ToyData$Z, W=W12, X=X34, B=B, verbose=FALSE )
print( tst3c )
```
...
tst3d <- fishpidetect.interact( Y=ToyData$Y, Z=ToyData$Z, W=Wfull, B=B, verbose=FALSE )
print( tst3d )
```
